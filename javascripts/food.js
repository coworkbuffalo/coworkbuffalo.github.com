...
$(function() {
  ...
  trucks = ["whereslloyd", "RoamingBuffalo1", "RnRBBQTruck", "TheKnightSlider", "amys_truck", "theBMFT", "FindFrankNow", "TheCheesyChick", "RollingJoeCafe", "SweetHearthNY", "MobileWoodFire", "WholeHogTruck"];
  $list = $("#trucks");
  _results = [];
